...
class EmployeeDynamicFields2(models.TransientModel):
    _name = 'wizard.dynamic.fields2'
    _description = 'Dynamic Fields2'
    ...
    def create_fields(self):
        ...
        self.env['ir.ui.view'].sudo().create({'name': 'purchase.order.dynamic.fields',
                                              'type': 'form',
    ...
    rel_field = fields.Many2one('ir.model.fields', string='Champs en relation')
    ttype = fields.Selection(selection='get_field_types', string='Type de Champs', required=True)
